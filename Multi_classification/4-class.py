from Multi_classification import dataset_split
from Multi_classification.img_fea_generator import *
from Multi_classification.sift_bof import *
...
if __name__ == '__main__':
    ...
    joblib.dump((im_distribution, n_features, dic), "4c_features_last.pkl", compress=3)

    train_path = '/home/yfy/Desktop/projects/ImageNet/fly/fly_small/train'
    im_distribution, n_features, dic = joblib.load('4c_features_last.pkl')
    aug = 3
    aug_size = 1 + aug
    ...
    train1.to_csv('4c_train_last.csv')
